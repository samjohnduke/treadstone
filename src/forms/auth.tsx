...
class InnerForm extends React.Component<InjectedFormikProps<AllFormProps, FormValues>> { 
  public render() {
    return (
      <Form onSubmit={this.props.handleSubmit}>
        ...
        <FormBar>
          <div>
            <Button type="submit" disabled={this.props.isSubmitting || !this.props.isValid}>Go</Button>
          </div>
          <div>
