  ...
  public render() {
    return (
      <Form onSubmit={this.props.handleSubmit}>
        ...
        <h3>Enter your email address and we will send you an email to change it.</h3>
        <TextInput 
          label="Email Address" 
          type="email" 
          name="email" 
        ...
        <FormBar>
          <div>
            <Button type="submit" disabled={this.props.isSubmitting || !this.props.isValid}>Send</Button>
          </div>
          <div>
